...
const Footer = () => {
  return (
    <footer className="bg-purple-900 text-purple-200 mt-16" data-testid="footer">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2">
                <Mail className="h-5 w-5 mt-0.5 text-purple-300" />
                <div>
                  <p>alaxicohealthcare@gmail.com</p>
                  <p className="text-xs text-purple-400">alaxicocustomer.care@gmail.com</p>
                </div>
              </li>
              <li className="flex items-start space-x-2">
                <Phone className="h-5 w-5 mt-0.5 text-purple-300" />
